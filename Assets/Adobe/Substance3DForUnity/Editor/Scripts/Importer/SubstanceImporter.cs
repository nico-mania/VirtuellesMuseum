...
namespace Adobe.SubstanceEditor.Importer
{
    ...
    public sealed class SubstanceImporter : ScriptedImporter
    {
...
#if UNITY_2022_2
                EditorTools.CreateSubstanceInstanceAsync(ctx.assetPath, rawData, $"graph_{i}", i, guid, true);
#else
        ...
        private void UpdateSubstanceFile(AssetImportContext ctx)
        {
            ...
            foreach (var instance in _fileAsset.Instances)
            {
                EditorTools.UpdateSubstanceInstance(instance, rawData);
