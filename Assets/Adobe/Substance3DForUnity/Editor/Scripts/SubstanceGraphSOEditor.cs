...
namespace Adobe.SubstanceEditor
{
    ...
    public class SubstanceGraphSOEditor : UnityEditor.Editor
    {
        ...
        private static bool _showPhysicalSizeOffsets = false;

        private void DrawPhysicalSizeOffsets(Material material)
        {
            EditorGUI.indentLevel++;
            _showPhysicalSizeOffsets = EditorGUILayout.Foldout(_showPhysicalSizeOffsets, "Offsets");
            if (_showPhysicalSizeOffsets)
            {
                DrawPhysicalSizePositionOffset(material);
                DrawPhysicalSizeRotationOffset(material);
            }
            EditorGUI.indentLevel--;
        }
        ...
        private void DrawPhysicalSizePositionOffset(Material material)
        {
            EditorGUI.indentLevel++;
        ...
        private static bool _showPhysicalSizeRotationOffset = false;

        private void DrawPhysicalSizeRotationOffset(Material material)
        {
            EditorGUI.indentLevel++;

            _showPhysicalSizeRotationOffset = EditorGUILayout.Foldout(_showPhysicalSizeRotationOffset, "Rotation Offset");
            if (_showPhysicalSizeRotationOffset)
            {
