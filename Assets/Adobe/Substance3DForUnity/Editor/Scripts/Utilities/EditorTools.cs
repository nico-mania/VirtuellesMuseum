...
namespace Adobe.SubstanceEditor
{
    internal static class EditorTools
    {
        ...
        public static void UpdateSubstanceInstance(SubstanceGraphSO instanceAsset, SubstanceFileRawData newFileData)
        {
            ...
            SubstanceEditorEngine.instance.InitializeInstance(instanceAsset, null);
        ...
        public static void CreateSubstanceInstanceAsync(string assetPath, SubstanceFileRawData fileData, string name, int index, string guid, bool isRoot = false, SubstanceGraphSO copy = null)
        {
            var instanceAsset = ScriptableObject.CreateInstance<SubstanceGraphSO>();
            instanceAsset.AssetPath = assetPath;
            instanceAsset.RawData = fileData;
            ...
            SubstanceEditorEngine.instance.InitializeInstance(instanceAsset, instancePath);
            SubstanceEditorEngine.instance.CreateGraphObject(instanceAsset, copy);
            SubstanceEditorEngine.instance.DelayAssetCreation(instanceAsset, instancePath);
        }
